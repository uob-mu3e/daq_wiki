...
* Testing round robin readout: `./farm_pc/tools/swb_dmatest 2 0 0 0x1 1` -> when to program enters the write file state you can kill it with `ctrl+c`
* Testing merger readout: `./farm_pc/tools/swb_dmatest 3 0 0 0x1 1` -> when to program enters the write file state you can kill it with `ctrl+c`
