...
* NB: We have to make sure FEs do not overwrite the ODB when restarted - how far did we get with that?
* NB: Should do a SciTile FPGA Pinout in order to sign off on the DAB schematics, who?
* NB: Plans and goals for this week?
